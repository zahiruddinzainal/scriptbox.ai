                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="form w-100">
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Sign In to ScriptBox.ai</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">AI and Automation is the future. Embrace the
                                    changes!</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="../../demo44/dist/authentication/layouts/corporate/reset-password.html"
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                    ...
                                    <span data-kt-element="lang-name">Malay</span>
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="assets/media/flags/china.svg" alt="" />
                                    </span>
                                    <span data-kt-element="lang-name">Chinese</span>
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1"
                                            src="assets/media/flags/india.svg" alt="" />
                                    </span>
                                    <span data-kt-element="lang-name">Indian</span>
                                </a>
                            </div>
                            <!--end::Menu item-->
                        </div>
