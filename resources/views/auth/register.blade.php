                        ...
                        <form method="POST" action="{{ route('register') }}" class="form w-100">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input id="name" type="text"
                                    ...
                                    name="name" value="{{ old('name') }}" placeholder="Display Name" required
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input id="password-confirm" placeholder="Confirm Password" type="password"
                                    class="form-control bg-transparent" name="password_confirmation" required
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Already have an Account?
                                <a href="../../demo44/dist/authentication/layouts/corporate/sign-in.html"
